...
export default function Initial({ props }: { props: Session | null }) {
    ...
    useEffect(() => {
        ...
        if ((!isCheckRoleChanges || !checkRoleChangesOnUtc || (checkRoleChangesOnUtc && dayjs.utc(checkRoleChangesOnUtc) < dayjs.utc()) || (waitingForUnlockingOnUtc && dayjs.utc() < dayjs.utc(waitingForUnlockingOnUtc))) && token) {
